...
public final class ArrayBag<T> implements BagInterface<T> {
    ...
    /** Copy constructor that creates a new ArrayBag object by copying the contentsof another ArrayBag object.
     *  @param other The ArrayBag object to be copied. */
    public ArrayBag(ArrayBag<T> other){
        this.numberOfEntries = other.numberOfEntries;
        @SuppressWarnings("unchecked")
        T[] tempBag = (T[]) new Object[other.bag.length];
        System.arraycopy(other.bag, 0, tempBag, 0, other.bag.length);
        this.bag = tempBag;
